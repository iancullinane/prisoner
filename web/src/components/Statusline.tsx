export default function Statusline() {
  return (
    <footer className="flex flex-none items-center justify-between gap-4 border-t border-frame-dim bg-black px-3.5 py-1 text-[11.5px] tracking-[.06em] text-dimmer">
